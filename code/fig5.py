...
lvrt_points = np.array([
    [min_plot_time, lower_range], [0, lower_range], [0, 0.6], [0.15, 0.6],
    [0.15, lower_range-0.05], [0.6, lower_range-0.05], [0.6, lower_range], [max_plot_time, lower_range]
])
...
y_tick_values = np.sort(np.append(np.arange(0, 1.21, 0.1), lower_range))
...
plt.tight_layout()
plt.savefig(f"../plots/fig5_0{int(lower_range * 100)}_110.png", dpi=800, bbox_inches='tight')
